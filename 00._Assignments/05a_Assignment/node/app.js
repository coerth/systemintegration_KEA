...
app.post('/cancelpayment', express.json(), (req, res) => {
...
app.post('/order', express.json(), (req, res) => {
    ...
    const webhook = 'https://morten.serveo.net/updatepayment'; // my webhook URL
    ...
    db.run(`INSERT INTO orders (amount, payment_status) VALUES (?,?)`, [amount, 'pending'], function(err) {
        if (err) {
            ...
            fetch('https://68e52e7de334ca2906512fce5c991d5f.serveo.net/payment', { // exposee webhook URL
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
